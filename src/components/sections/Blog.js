    ...
    <section className="blog main-section flex-column-mobile" id="blog">
      ...
      <div className="latestposts flex-column-mobile">
        ...
        <div className="animated-layer fade-in-right-animation fadeInUp wow">
          <Link href="/pages/como-ganarle-a-la-oferta-corrupta" legacyBehavior>
            <a>
        ...
        {/* POST ITEM STARTS */}
        <div className="animated-layer fade-in-right-animation fadeInUp wow">
          <Link href="/pages/como-vivir-de-las-licitaciones" legacyBehavior>
            <a>
              <span className="img-holder">
        ...
        {/* POST ITEM STARTS */}
        <div className="animated-layer fade-in-right-animation fadeInUp wow">
          <Link href="/pages/crea-un-plan-y-luego-tu-empresa" legacyBehavior>
            <a>
              <span className="img-holder">
